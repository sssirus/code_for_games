...
import trlx
from examples.wordle.generate_dataset import generate_dataset
...
default_config = TRLConfig(
    train=TrainConfig(
        ...
        checkpoint_dir="/data/user_model/wordle/checkpoints/sft_wordle/hf_model/",
    ),
    model=ModelConfig(model_path="/data/pretrain_model/llama-huggingface-7b/", num_layers_unfrozen=2),
    ...
    method=SFTConfig(
        name="sftconfig",
        gen_kwargs=dict(max_new_tokens=2, top_k=3, top_p=1.0, do_sample=True),
    ),
)

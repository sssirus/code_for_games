...
default_config = TRLConfig(
    ...
    model=ModelConfig(model_path="/data/user_model/wordle/checkpoints/sft_wordle/hf_model/checkpoint_10000/hf_model/", num_layers_unfrozen=1),
    ...
    scheduler=SchedulerConfig(name="cosine_annealing", kwargs=dict(T_max=1e12, eta_min=3.0e-4)),
    method=PPOConfig(
        name="PPOConfig",
        num_rollouts=32,
        chunk_size=32,
